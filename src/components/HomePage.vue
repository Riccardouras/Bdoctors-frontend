        ...
        <div class="row justify-content-center">
          <div class="col-xl-4 col-md-6 col-sm-12 d-flex justify-content-center mt-2"
            ...
            <div class="card cardPremium">
              ...
              <div class="content">
                <h5 class="card-title fw-bold"><router-link :to="`/doctorpage/${doctor.id}`">{{ doctor.name }}</router-link></h5>
                <span>Specializzato in:</span>
                <ul class="list-unstyled">
                  <li class="specialization text-center text-black" v-for="specialty in doctor.specialties">{{ specialty }}</li>
                </ul>
